...
function BottomNav() {
  ...
  const isLogWorkout = location.pathname.startsWith('/logworkout')
  ...
  return (
    <nav className="bottom-nav" ref={navRef}>
      ...
      <NavLink
        to="/history"
        ref={(el) => (linkRefs.current['/history'] = el)}
        className={navLinkClass}
      >
        <svg
          viewBox="0 0 24 24"
      ...
      <div
        className={`bottom-nav-center${isLogWorkout ? ' active' : ''}`}
      >
        <NavLink
          to="/logworkout"
      ...
      <NavLink
        to="/progress"
        ref={(el) => (linkRefs.current['/progress'] = el)}
        className={navLinkClass}
      >
        <svg
          viewBox="0 0 24 24"
